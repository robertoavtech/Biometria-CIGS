...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">
                Bem vindo ao Sistema de Controle de Horas de Selva...
            </h2>             
        </div>
    </div>
    <br><br><br>
    ...
    <div class="row justify-content-center">
        <img src="img/cigs.gif" class="media-object" style="width: 150px;">        
    </div>
    <div class="row">
    <!--form action="resultado.php" method="post"-->
        ...
        <br><br><br>            
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-secondary" name="busca_filtro" type="submit">Buscar</button>
                </span> 
            </div>
